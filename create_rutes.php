...
function pick_rute(table, j='none') {
        ...
        for (i=0; i<rows_ch.length; i++){
            if(rows_ch[i].getAttribute("value") != "edit"){
                if (i % 2 == 0){
                	rows_ch[i].style.background = "#fff";
				}
				else{
					rows_ch[i].style.background = "#eee";
				}
        ...
        for (i=0; i<rows_su.length; i++){
            if(rows_su[i].getAttribute("value") != "edit"){
                if (i % 2 == 0){
                	rows_su[i].style.background = "#fff";
				}
				else{
					rows_su[i].style.background = "#eee";
				}
...
<body onload="init()"; style="width:1200px; height=800px">
    ...
    <div style="width:57%; height:85%; float:left; margin-left:5px">
		<div style="width:100%; height:75%; float:left" id="map">
		</div>
