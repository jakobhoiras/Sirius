...
for ($i=0; $i<$zones_num; $i++){
    ...
    echo "<tr value='np' id='row" . $zoneID . "' onclick=pick_row($zoneID) onmouseover=temppick_row($zoneID) onmouseout=unpick_row($zoneID)>";
    echo "<td>" . (string)$table[$i][0] . "</td>";
    echo "<td>" . round($table[$i][1],3) . "</td>";
    echo "<td>" . round($table[$i][2],3) . "</td>";
